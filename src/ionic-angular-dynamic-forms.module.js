...
let IonicAngularDynamicForms = class IonicAngularDynamicForms {
};
IonicAngularDynamicForms = __decorate([
    NgModule({
        declarations: [
...
], IonicAngularDynamicForms);
export { IonicAngularDynamicForms };
//# sourceMappingURL=ionic-angular-dynamic-forms.module.js.map